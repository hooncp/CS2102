...
-- not used anymore. Delivers generated by triggers now.
...
\copy Orders(userId, promoCode, applicableTo, modeOfPayment, timeOfOrder, deliveryLocation, usedRewardPoints) from './CSVFILES/smallorders.csv' CSV HEADER;
\copy Contains(orderId, fname, rname, foodQty, reviewContent) from './CSVFILES/smallcontains.csv' CSV HEADER;
