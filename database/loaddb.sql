...
\copy Users(name, dateCreated) from './Users.csv' CSV HEADER; --100 user
...
\copy Promotions(promoCode, promoDesc, createdBy, applicableTo, discUnit, discRate, startDate, endDate) from '/Promotions.csv' CSV HEADER;
\copy MinSpendingPromotions(promoCode, applicableTo, minAmt) from '/MinSpendingpromotions.csv' CSV HEADER;
\copy CustomerPromotions(promoCode, applicableTo, minTimeFromLastOrder) from '/CustomerPromotions.csv' CSV HEADER;
...
\copy Orders(userId, promoCode, applicableTo, modeOfPayment, timeOfOrder, deliveryLocation, usedRewardPoints) from '/Orders.csv' CSV HEADER;
\copy Contains(orderId, fname, rname, foodQty, reviewContent) from '/Contains.csv' CSV HEADER;
\copy Delivers(orderId, userId, departTimeForRestaurant, departTimeFromRestaurant, arrivalTimeAtRestaurant, deliveryTimetoCustomer, rating) from '/Delivers.csv' CSV HEADER;
